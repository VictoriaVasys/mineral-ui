...
export default [
  {
    ...
    slug: 'checkbox',
    title: 'Checkbox',
    whenHowToUse: `Use a Checkbox to allow users to select one or more options
from a list.

Use Checkboxes to change settings rather than initiate actions.

Mineral UI also provides a [CheckboxGroup](../checkbox-group), which offers a simpler
API for creating a group of Checkboxes, and [FormField](../form-field) to provide an
