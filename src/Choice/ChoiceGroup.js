...
export const componentTheme = (baseTheme: Object) => ({
  ChoiceGroup_marginHorizontal_inline: baseTheme.space_inline_xl,
  ChoiceGroup_marginVertical: baseTheme.space_stack_md,
  ChoiceGroup_marginVertical_jumbo: baseTheme.space_stack_lg,
    ...
    return {
      ...
      '& > *:not(:last-child)': {
        marginBottom: inline
          ? 0
          : size === 'jumbo'
            ? theme.ChoiceGroup_marginVertical_jumbo
            : theme.ChoiceGroup_marginVertical,
        marginRight: inline
          ? theme.ChoiceGroup_marginHorizontal_inline
          : undefined
      }
    };
  }
